...
var authDb *authdb = &authdb{
	sessions: make(map[string]*webauthn.SessionData),
}

// GetUser returns a *User by the user's username
func (db *authdb) GetSession(sessionID string) (*webauthn.SessionData, error) {
...
func (db *authdb) DeleteSession(sessionID string) {
	db.mu.Lock()
	defer db.mu.Unlock()
...
func (db *authdb) StartSession(data *webauthn.SessionData) string {
